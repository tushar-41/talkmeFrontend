...
const SignUpPage = () => {
  ...
  return (
    <div className="absolute right-30 h-120 w-100 border rounded-2xl bg-white/20 backdrop-blur-2xl flex flex-col items-center gap-5">
      <h1
        className="text-2xl tracking-tighter font-bold bg-black
             text-transparent bg-clip-text mt-6"
      >
        Hello Cutie Signup please
      </h1>
      <form
        onSubmit={handleSubmit}
        className="flex flex-col items-center justify-center"
      >
        <label htmlFor="name" className="text-xl font-semibold pr-10 mb-2">
          Name
        </label>
        <input
          type="text"
          ...
          required
        />
        <label htmlFor="email" className="text-xl font-semibold pr-10 mb-2">
          Email
        </label>
        <input
          type="text"
          ...
          required
        />
        <label htmlFor="password" className="text-xl font-semibold pr-10 mb-2">
          Password
        </label>
        <input
          type="password"
